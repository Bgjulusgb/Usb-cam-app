...
import type { UsbDeviceInfo, PreviewConfig, PreviewResult } from '../models/DeviceProfile';
...
export class UsbCameraService {
  ...
  async startPreview(config: PreviewConfig): Promise<PreviewResult> {
    return UsbCameraPlugin.startPreview(config);
  }
