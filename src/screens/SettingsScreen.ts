...
export class SettingsScreen {
  ...
  attachEvents(container: HTMLElement): void {
    ...
    const save = () => {
      const resValue = (container.querySelector('#set-resolution') as HTMLSelectElement).value;
      ...
      this.onSave({ width, height, fps, format, lowLatencyMode: lowLatency, enableRtsp: rtsp, rtspPort });
    };
