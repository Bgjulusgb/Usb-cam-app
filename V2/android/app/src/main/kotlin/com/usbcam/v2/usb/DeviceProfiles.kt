...
object DeviceDatabase {
    ...
    fun buildGenericUvc(vid: Int, pid: Int, name: String) = DeviceProfile(
        vid, pid, DeviceType.UVC_STANDARD, name,
        supportedFormats = listOf("MJPG","YUY2","H264","H265","NV12"), isUvc = true
    )
}
